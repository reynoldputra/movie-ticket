...
export default function Navbar() {
  ...
  return (
    <div className="h-24 bg-gradient-to-b from-black/30 fixed w-full flex justify-between items-center">
      <p className="w-64 text-white text-center font-bold">App name</p>
